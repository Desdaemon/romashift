...
Gui, Add, DropDownList, x82 y29 w140 Choose%R_InputMode% gUpdate_R_InputMode vR_InputMode AltSubmit, Native Input|Dubeolshift
...
GUI_Help_Initialize:
Gui Help:New
Gui Help:Add, Picture, x12 y9 w50 h50 , ro_full.png
...
Gui Help:Add, Tab, x12 y69 w370 h400 , Input Modes|Instructions|Vowels (Native Input)|Vowels (Dubeolshift)|About
...
Only applicable for Dubeolshift. Native Input automatically inputs the silent ieung.
...
Toggle_R_InputMode:
R_InputMode := !R_InputMode
IniWrite, %R_InputMode%, rm_settings.ini, General, InputMode
Menu, Tray, ToggleCheck, Native Input
Menu, Tray, ToggleCheck, Dubeolshift
return
